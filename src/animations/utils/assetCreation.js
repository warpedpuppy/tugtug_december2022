...
//   opCounter: 0,
//   init () {
//     this.ringQ = (this.utils.app.renderer instanceof PIXI.Renderer) ? Config.bounceTotalPoints : 100
//     for (let i = 0; i < this.ringQ; i++) {
//       this.lines.push(this.Graphics())
//       this.rings.push(this.Sprite('transparentRing.png'))
//     }

//     this.coinQ = (this.utils.app.renderer instanceof PIXI.Renderer) ? Config.flyCoinsPerTreasureChest : 10
...
//     this.opQ = (this.utils.app.renderer instanceof PIXI.Renderer) ? 300 : 50
...
//   },
//   webgl () {
//     return this.utils.app.renderer instanceof PIXI.Renderer
//   },
//   ParticleContainer (q) {
